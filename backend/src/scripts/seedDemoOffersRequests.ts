...
const organizations = [
  ...
  { name: 'PhonePe', domain: 'phonepe.com', logo_url: 'https://logo.clearbit.com/phonepe.com' },
  { name: 'Lenskart', domain: 'lenskart.com', logo_url: 'https://logo.clearbit.com/lenskart.com' },
  { name: 'Haptik', domain: 'haptik.ai', logo_url: 'https://logo.clearbit.com/haptik.ai' },
  { name: 'Cars24', domain: 'cars24.com', logo_url: 'https://logo.clearbit.com/cars24.com' },
  { name: 'Meesho', domain: 'meesho.com', logo_url: 'https://logo.clearbit.com/meesho.com' },
  { name: 'Elevation Capital', domain: 'elevationcapital.com', logo_url: 'https://logo.clearbit.com/elevationcapital.com' },
  { name: 'Kalaari Capital', domain: 'kalaari.com', logo_url: 'https://logo.clearbit.com/kalaari.com' },
  { name: 'Nexus Venture Partners', domain: 'nexusvp.com', logo_url: 'https://logo.clearbit.com/nexusvp.com' },
  { name: 'SAIF Partners', domain: 'saifpartners.com', logo_url: 'https://logo.clearbit.com/saifpartners.com' },
  { name: 'Stellaris', domain: 'stellarisvp.com', logo_url: 'https://logo.clearbit.com/stellarisvp.com' },
  { name: 'India Quotient', domain: 'indiaquotient.in', logo_url: 'https://logo.clearbit.com/indiaquotient.in' },
  { name: 'Ajio', domain: 'ajio.com', logo_url: 'https://logo.clearbit.com/ajio.com' },
  { name: 'Shopify', domain: 'shopify.com', logo_url: 'https://logo.clearbit.com/shopify.com' },
  { name: 'BigBasket', domain: 'bigbasket.com', logo_url: 'https://logo.clearbit.com/bigbasket.com' },
  { name: 'FirstCry', domain: 'firstcry.com', logo_url: 'https://logo.clearbit.com/firstcry.com' },
  { name: 'Pepperfry', domain: 'pepperfry.com', logo_url: 'https://logo.clearbit.com/pepperfry.com' },
  { name: 'Postman', domain: 'postman.com', logo_url: 'https://logo.clearbit.com/postman.com' },
  { name: 'Clevertap', domain: 'clevertap.com', logo_url: 'https://logo.clearbit.com/clevertap.com' },
  { name: 'Netcore', domain: 'netcorecloud.com', logo_url: 'https://logo.clearbit.com/netcorecloud.com' },
  { name: 'Wingify', domain: 'wingify.com', logo_url: 'https://logo.clearbit.com/wingify.com' },
  { name: 'Verloop.io', domain: 'verloop.io', logo_url: 'https://logo.clearbit.com/verloop.io' },
  { name: 'Exotel', domain: 'exotel.com', logo_url: 'https://logo.clearbit.com/exotel.com' },
  { name: 'MoEngage', domain: 'moengage.com', logo_url: 'https://logo.clearbit.com/moengage.com' },
  { name: 'Dunzo', domain: 'dunzo.com', logo_url: 'https://logo.clearbit.com/dunzo.com' },
  { name: 'Licious', domain: 'licious.in', logo_url: 'https://logo.clearbit.com/licious.in' },
  { name: 'Mamaearth', domain: 'mamaearth.in', logo_url: 'https://logo.clearbit.com/mamaearth.in' },
  { name: 'CRED', domain: 'cred.club', logo_url: 'https://logo.clearbit.com/cred.club' },
  { name: 'Jupiter', domain: 'jupiter.money', logo_url: 'https://logo.clearbit.com/jupiter.money' },
  { name: 'Groww', domain: 'groww.in', logo_url: 'https://logo.clearbit.com/groww.in' },
  { name: 'Dream11', domain: 'dream11.com', logo_url: 'https://logo.clearbit.com/dream11.com' },
  { name: 'MPL', domain: 'mpl.live', logo_url: 'https://logo.clearbit.com/mpl.live' },
  { name: 'CoinDCX', domain: 'coindcx.com', logo_url: 'https://logo.clearbit.com/coindcx.com' },
  { name: 'CoinSwitch', domain: 'coinswitch.co', logo_url: 'https://logo.clearbit.com/coinswitch.co' },
  { name: 'Zebpay', domain: 'zebpay.com', logo_url: 'https://logo.clearbit.com/zebpay.com' },
  { name: 'Mudrex', domain: 'mudrex.com', logo_url: 'https://logo.clearbit.com/mudrex.com' },
  { name: 'Solana', domain: 'solana.com', logo_url: 'https://logo.clearbit.com/solana.com' },
  { name: 'Binance', domain: 'binance.com', logo_url: 'https://logo.clearbit.com/binance.com' },
  { name: 'Unstoppable Domains', domain: 'unstoppabledomains.com', logo_url: 'https://logo.clearbit.com/unstoppabledomains.com' },
  { name: 'Urban Company', domain: 'urbancompany.com', logo_url: 'https://logo.clearbit.com/urbancompany.com' },
  { name: 'Delhivery', domain: 'delhivery.com', logo_url: 'https://logo.clearbit.com/delhivery.com' },
  { name: 'Porter', domain: 'porter.in', logo_url: 'https://logo.clearbit.com/porter.in' },
  { name: 'Shadowfax', domain: 'shadowfax.in', logo_url: 'https://logo.clearbit.com/shadowfax.in' },
  { name: 'Ecom Express', domain: 'ecomexpress.in', logo_url: 'https://logo.clearbit.com/ecomexpress.in' },
  { name: 'Shiprocket', domain: 'shiprocket.in', logo_url: 'https://logo.clearbit.com/shiprocket.in' },
  { name: '1mg', domain: '1mg.com', logo_url: 'https://logo.clearbit.com/1mg.com' },
  { name: 'Portea', domain: 'portea.com', logo_url: 'https://logo.clearbit.com/portea.com' },
  { name: 'MFine', domain: 'mfine.co', logo_url: 'https://logo.clearbit.com/mfine.co' },
  { name: 'Truemeds', domain: 'truemeds.in', logo_url: 'https://logo.clearbit.com/truemeds.in' },
  { name: 'DocsApp', domain: 'docsapp.in', logo_url: 'https://logo.clearbit.com/docsapp.in' },
  { name: 'HealthifyMe', domain: 'healthifyme.com', logo_url: 'https://logo.clearbit.com/healthifyme.com' },
  { name: 'Omnicuris', domain: 'omnicuris.com', logo_url: 'https://logo.clearbit.com/omnicuris.com' },
  { name: 'Sugar Cosmetics', domain: 'sugarcosmetics.com', logo_url: 'https://logo.clearbit.com/sugarcosmetics.com' },
  { name: 'Bewakoof', domain: 'bewakoof.com', logo_url: 'https://logo.clearbit.com/bewakoof.com' },
  { name: 'Boat', domain: 'boat-lifestyle.com', logo_url: 'https://logo.clearbit.com/boat-lifestyle.com' },
  { name: 'FabIndia', domain: 'fabindia.com', logo_url: 'https://logo.clearbit.com/fabindia.com' },
  { name: 'WowSkin Science', domain: 'buywow.in', logo_url: 'https://logo.clearbit.com/buywow.in' },
  { name: 'Purplle', domain: 'purplle.com', logo_url: 'https://logo.clearbit.com/purplle.com' },
  { name: 'Clovia', domain: 'clovia.com', logo_url: 'https://logo.clearbit.com/clovia.com' },
  { name: 'Rare Rabbit', domain: 'rarerabbit.in', logo_url: 'https://logo.clearbit.com/rarerabbit.in' },
  { name: 'Slice', domain: 'sliceit.com', logo_url: 'https://logo.clearbit.com/sliceit.com' },
  { name: 'Uni Cards', domain: 'uni.club', logo_url: 'https://logo.clearbit.com/uni.club' },
  { name: 'Khatabook', domain: 'khatabook.com', logo_url: 'https://logo.clearbit.com/khatabook.com' },
  { name: 'BharatPe', domain: 'bharatpe.com', logo_url: 'https://logo.clearbit.com/bharatpe.com' },
  { name: 'PolicyBazaar', domain: 'policybazaar.com', logo_url: 'https://logo.clearbit.com/policybazaar.com' },
  { name: 'ET Money', domain: 'etmoney.com', logo_url: 'https://logo.clearbit.com/etmoney.com' },
  { name: 'Zerodha', domain: 'zerodha.com', logo_url: 'https://logo.clearbit.com/zerodha.com' },
  { name: 'Smallcase', domain: 'smallcase.com', logo_url: 'https://logo.clearbit.com/smallcase.com' },
  { name: 'Rebel Foods', domain: 'rebelfoods.com', logo_url: 'https://logo.clearbit.com/rebelfoods.com' },
  { name: 'Chaayos', domain: 'chaayos.com', logo_url: 'https://logo.clearbit.com/chaayos.com' },
  { name: 'ID Fresh Foods', domain: 'idfreshfood.com', logo_url: 'https://logo.clearbit.com/idfreshfood.com' },
  { name: 'Country Delight', domain: 'countrydelight.in', logo_url: 'https://logo.clearbit.com/countrydelight.in' },
  { name: 'NoBroker', domain: 'nobroker.in', logo_url: 'https://logo.clearbit.com/nobroker.in' },
  { name: 'Housing.com', domain: 'housing.com', logo_url: 'https://logo.clearbit.com/housing.com' },
  { name: 'Nestaway', domain: 'nestaway.com', logo_url: 'https://logo.clearbit.com/nestaway.com' },
  { name: 'Square Yards', domain: 'squareyards.com', logo_url: 'https://logo.clearbit.com/squareyards.com' },
  { name: 'MakeMyTrip', domain: 'makemytrip.com', logo_url: 'https://logo.clearbit.com/makemytrip.com' },
  { name: 'Cleartrip', domain: 'cleartrip.com', logo_url: 'https://logo.clearbit.com/cleartrip.com' },
  { name: 'Bounce', domain: 'bounce.bike', logo_url: 'https://logo.clearbit.com/bounce.bike' },
  { name: 'Rapido', domain: 'rapido.bike', logo_url: 'https://logo.clearbit.com/rapido.bike' },
  { name: 'Uber', domain: 'uber.com', logo_url: 'https://logo.clearbit.com/uber.com' },
  { name: 'Yatra', domain: 'yatra.com', logo_url: 'https://logo.clearbit.com/yatra.com' },
  { name: 'Byju\'s', domain: 'byjus.com', logo_url: 'https://logo.clearbit.com/byjus.com' },
  ...
  { name: 'Oracle', domain: 'oracle.com', logo_url: 'https://logo.clearbit.com/oracle.com' },
  { name: 'Salesforce', domain: 'salesforce.com', logo_url: 'https://logo.clearbit.com/salesforce.com' },
  { name: 'Snapdeal', domain: 'snapdeal.com', logo_url: 'https://logo.clearbit.com/snapdeal.com' },
  { name: 'Deloitte', domain: 'deloitte.com', logo_url: 'https://logo.clearbit.com/deloitte.com' },
  { name: 'EY', domain: 'ey.com', logo_url: 'https://logo.clearbit.com/ey.com' },
  { name: 'Hotstar', domain: 'hotstar.com', logo_url: 'https://logo.clearbit.com/hotstar.com' },
  { name: 'Sony', domain: 'sony.com', logo_url: 'https://logo.clearbit.com/sony.com' },
  { name: 'OYO', domain: 'oyorooms.com', logo_url: 'https://logo.clearbit.com/oyorooms.com' },
  { name: '99acres', domain: '99acres.com', logo_url: 'https://logo.clearbit.com/99acres.com' },
  { name: 'LIC', domain: 'licindia.in', logo_url: 'https://logo.clearbit.com/licindia.in' },
  { name: 'ICICI Lombard', domain: 'icicilombard.com', logo_url: 'https://logo.clearbit.com/icicilombard.com' },
  { name: 'Blume Ventures', domain: 'blume.vc', logo_url: 'https://logo.clearbit.com/blume.vc' },
  { name: 'Mumbai Angels', domain: 'mumbaiangels.com', logo_url: 'https://logo.clearbit.com/mumbaiangels.com' },
  { name: 'Matrix Partners', domain: 'matrixpartners.in', logo_url: 'https://logo.clearbit.com/matrixpartners.in' },
  { name: 'WestBridge Capital', domain: 'westbridge.com', logo_url: 'https://logo.clearbit.com/westbridge.com' },
  { name: 'Times Internet', domain: 'timesinternet.in', logo_url: 'https://logo.clearbit.com/timesinternet.in' },
  { name: 'IIT Delhi', domain: 'iitd.ac.in', logo_url: 'https://logo.clearbit.com/iitd.ac.in' },
  { name: 'Sharechat', domain: 'sharechat.com', logo_url: 'https://logo.clearbit.com/sharechat.com' },
  { name: 'UpGrad', domain: 'upgrad.com', logo_url: 'https://logo.clearbit.com/upgrad.com' },
  { name: 'BCG', domain: 'bcg.com', logo_url: 'https://logo.clearbit.com/bcg.com' },
  { name: 'Goldman Sachs', domain: 'goldmansachs.com', logo_url: 'https://logo.clearbit.com/goldmansachs.com' },
];
