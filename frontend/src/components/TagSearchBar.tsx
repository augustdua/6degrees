...
export const TagSearchBar: React.FC<TagSearchBarProps> = ({
  ...
  return (
    <div ref={searchRef} className="relative w-full max-w-3xl mx-auto mb-4 md:mb-6 px-4">
      <div className="relative">
        <Search className="absolute left-7 sm:left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 sm:h-5 sm:w-5 text-muted-foreground" />
        <Input
          type="text"
