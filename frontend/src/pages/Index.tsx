        ...
        <div className="container mx-auto px-4 md:px-6 py-16 md:py-24 relative">
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-sm font-semibold uppercase tracking-[0.2em] text-foreground/70">
            ...
            <div className="w-full">
              <img
                ...
                className="h-72 md:h-[420px] w-full rounded-3xl object-cover shadow-lg"
              />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-16">
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] items-center">
            <img
              ...
              className="h-64 md:h-80 w-full rounded-3xl object-cover shadow-lg"
            />
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-foreground/80">The problem isn't founders. It's the format.</p>
            </div>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-center">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-foreground/80">Every table follows the same structure.</p>
              <p className="mt-3 text-foreground/80">
          ...
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] items-center">
            ...
            <div className="max-w-2xl">
              ...
              <ol className="mt-4 space-y-4 text-foreground/80">
                <li>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-center">
            ...
            <img
              src="/lp_img_2.jpg"
              alt="Founder conversation across the table"
              className="h-64 md:h-80 w-full rounded-3xl object-cover shadow-lg"
            />
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] items-center">
            <img
              src="/lp_img_3.jpg"
              alt="Founders sharing a Saturday table"
              className="h-64 md:h-80 w-full rounded-3xl object-cover shadow-lg"
            />
            <div className="max-w-2xl">
              <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">The Ritual</h2>
              <div className="mt-4 grid gap-3 sm:grid-cols-2 text-foreground/80">
                <div>
              ...
              <p className="mt-4 text-foreground/80">One table. One sitting. Then you get your Saturday back.</p>
            </div>
          </div>
