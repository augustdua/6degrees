// This is a client-side fallback for generating dynamic OG images
// In a production environment, you'd want this on your backend server

function generateDynamicOGImage(params) {
  const {
    target = 'Target Person',
    reward = '0',
    creator = 'Someone',
    message = 'Help me reach my target connection!'
  } = params;

  const truncatedMessage = message.length > 60 ? message.substring(0, 57) + '...' : message;
  const truncatedTarget = target.length > 25 ? target.substring(0, 22) + '...' : target;
  ...
  return `
    <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
      ...
      <text x="680" y="245" font-family="Arial, sans-serif" font-size="20" fill="white" text-anchor="middle" font-weight="bold">$${reward}</text>
      ...
      <!-- Creator Info -->
      <text x="620" y="385" font-family="Arial, sans-serif" font-size="16" fill="#64748b">Requested by: ${creator}</text>
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { generateDynamicOGImage };
}
