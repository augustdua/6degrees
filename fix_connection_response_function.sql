-- Fix respond_to_direct_connection_request function
...
BEGIN
  ...
  IF p_response = 'accepted' THEN
    -- Create bidirectional connection using create_user_connection
...
-- Also ensure the create_user_connection function has proper permissions
GRANT EXECUTE ON FUNCTION public.create_user_connection TO authenticated;
GRANT EXECUTE ON FUNCTION public.create_user_connection TO anon;